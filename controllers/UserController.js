class UserController {
  ...
  onEdit() {
    ...
    this.formUpdateEl.addEventListener("submit", event => {
      ...
      let result = Object.assign({}, userOld, values); //Copía o valor de atributos de um objeto
      ...
      this.getPhoto(this.formUpdateEl).then(
        content => {
          ...
          tr.innerHTML = `
            <td><img src="
            ${result._photo}" alt="User Image" class="img-circle img-sm"></td>
            <td>${result._name}</td>
            <td>${result._email}</td>
  ...
  getValues(formEl) {
    ...
    [...formEl.elements].forEach((field, index) => {
      ...
      if (
        ...
        //console.dir() -> Exibe os dados do elemento em forme de arvore
  ...
  addLine(dataUser) {
    ...
    tr.innerHTML = `
          <td><img src="
          ${dataUser.photo}" alt="User Image" class="img-circle img-sm"></td>
          <td>${dataUser.name}</td>
  ...
  //Adicionar evento de click no botão editar da tr
  addEventTr(tr) {
